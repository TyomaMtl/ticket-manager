 ...
 */
final class Version20191126133339 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Moderation (ticket_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_C0EA6AA4700047D2 (ticket_id), INDEX IDX_C0EA6AA4A76ED395 (user_id), PRIMARY KEY(ticket_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
